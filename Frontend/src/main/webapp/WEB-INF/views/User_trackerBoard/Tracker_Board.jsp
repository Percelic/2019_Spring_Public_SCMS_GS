...
<%--                 	<a  href="<c:url value="/User_trackerBoard/Tracker_Board?head_lang=en" />"> --%>
                	<img  src="${path}/image/USA1.png">
                	</a>
                </li>
                <li class="">
                		<a onClick="changeLang('ko');"> 
<%--                 	<a  href="<c:url value="/User_trackerBoard/Tracker_Board?head_lang=ko" />"> --%>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                     <thead>
                        ...
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                  		   <th style="text-align:center;"><spring:message code="part.F1" text="default text"></spring:message></th>
                  		   <th style="text-align:center;"><spring:message code="part.F2" text="default text"></spring:message></th>
                           <th style="text-align:center;"><spring:message code="part.F3" text="default text"></spring:message></th>
                           <th style="text-align:center;"><spring:message code="part.F4" text="default text"></spring:message></th>
                           <th style="text-align:center;"><spring:message code="part.F5" text="default text"></spring:message></th>
                           <th style="text-align:center;"><spring:message code="part.F6" text="default text"></spring:message></th>
                           <th style="text-align:center;"><spring:message code="part.F7" text="default text"></spring:message></th>
                           <th style="text-align:center;"><spring:message code="part.F8" text="default text"></spring:message></th>
                        </tr>
                      </thead>
              <tbody> 
                 <c:forEach var="row" items="${list}">
                        ...
                        onmouseout="this.style.backgroundColor='#FFFFFF'">
                          ...
                          <td align="center">${row.tracker_model}</td>
                          <td align="center">${row.tracker_capacity}</td>
                          <td align="center">${row.tracker_username}</td>

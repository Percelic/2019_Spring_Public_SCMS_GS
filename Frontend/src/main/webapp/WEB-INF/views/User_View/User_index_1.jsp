        ...
        <div class="col-md-3 left_col" >
          <div class="left_col scroll-view" >
            <div class="navbar nav_title" style="border: 0;">
			 ...
			 <h3 align="center" style="color: #09f";>Solar<br>Monitioring<br>System V1.0</h3> 
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			 ...
			 <div class="clearfix"></div>
                <ul class="nav side-menu">
                                    <li><a href="${path}/User_View/User_index?t_group_id=700"><i class="fa fa-home"></i><h4><spring:message code="part.H1" text="default text"></spring:message></h4></a>
                  </li>

                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="clearfix"></div>
                    	                  <!-- 트래커 관리 DB 뿌리기 -->
		<%
			List<Map<String, Object>> Inverter_List = (List<Map<String, Object>>) request.getAttribute("Inverter_board");
		%>
	            <!-- 트래커 관리 DB 뿌리기 -->
                  </div>
                  <div class="x_content">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>연락처</th>
						   ...
						   <%
                    for(Map<String, Object> sub1 : Inverter_List){
                    %>
                      <tbody>
                        <tr>
                           <td class="a-center ">
                          ...
                          <td><%=sub1.get("Inverter_Model")%></td>
                          <td><%=sub1.get("Inverter_Capacity")%></td>
                          <td><%=sub1.get("Inverter_Manager")%></td>
                          <td><%=sub1.get("Inverter_Phone")%></td>
                        </tr>
                              <%
                    }
                        %>
                                             ...
                                             <div>            
            <a href='/Web/Inverter_insert' onClick='fn_write()' class="btn btn-success">등록</a>            

...
public class Utils {
	...
	public static <E> E[] ConvertArrayType(Object _nReadSplit, Class<E>  _type) 
	{
		/* Not Completed */
		E[] e = (E[])Array.newInstance(_type , ((Object[])_nReadSplit).length);

		for(int i = 0; i < ((Object[])_nReadSplit).length ; i++) 
		{
			e[i] = (E) ((Object[])_nReadSplit)[i];
		}
